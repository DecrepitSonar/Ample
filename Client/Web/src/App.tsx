...
function UserUpgrade(){
  return(
    <div className="upgrade_terms_container">

      <h1>Terms and Conditions</h1>
    <ul>
      <li>
         <h2>Introduction</h2>
          <p>This website is operated by [Merchant Name]. The terms “we”, “us”, and “our” refer to [Merchant Name]. The use of our website is subject to the following terms and conditions of use, as amended from time to time (the “Terms”). The Terms are to be read together by you with any terms, conditions or disclaimers provided in the pages of our website. Please review the Terms carefully. The Terms apply to all users of our website, including without limitation, users who are browsers, customers, merchants, vendors and/or contributors of content. If you access and use this website, you accept and agree to be bound by and comply with the Terms and our Privacy Policy. If you do not agree to the Terms or our Privacy Policy, you are not authorized to access our website, use any of our website’s services or place an order on our website.</p>
      </li>
      <li>
      ...
      <li>
        <h2>Use Comments, Feedback, and Other Submissions</h2>
        <p>
      ...
      <li>
        <h2>Governing Law</h2>
        <p>Any disputes arising out of or relating to the Terms, the Privacy Policy, use of our website, or our products or services offered on our website will be resolved in accordance with the laws of= the Province of [Name of Province] without regard to its conflict of law rules. Any disputes, actions or proceedings relating to the Terms or your access to or use of our website must be brought before the courts of the Province of [Name of Province] in the City of [Name of City],</p>
        <p>[Name of Province] and you irrevocably consent to the exclusive jurisdiction and venue of such courts.</p>
      </li>
      <li>
        <h2>Questions or Concerns</h2>
        <p>Please send all questions, comments and feedback to us at [Email Address].</p>
      </li>
    </ul> 
    <input type="radio" /> <span>I have read and understood the terms and conditions</span>
    <br />
    <button className='submit_button_solid'> Submit</button>
    </div>
  )
}
  ...
  return (
    <div className="App">
      ...
      <Routes>
        ...
        <Route path='/upgrade' element={<ProtectedRoute user={user}><UserUpgrade/> </ProtectedRoute>}/> 
